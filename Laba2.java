public class Laba2 {
    public static void main(String[] args) {
        //задаємо матриці та іх тип даних double
        double A[][] = {{4, 7, 7},
                {5, 1, 8},
                {4, 8, 4},
                {4, 5, 3},
        ...
        double B[][] = {{8, 1, 4},
                ...
                {4, 5, 6}};
        double S = 0;
        //встановлюємо макс1==0 типу флаг
        if (A.length == B.length) {
            int maxl = 0;
            //первірка на правильність вхідних даних
            for (int i = 0; i < A.length; i++) {
                if (A[i].length != B[i].length)
                    System.out.println("Невірні вхідні дані!");
            }
            //C = A^B(операція за варіантом з С) виключне "або"
            ...
            //сумування найменших елементів у кожному рядку
